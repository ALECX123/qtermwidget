...
namespace Konsole
{
    ...
    */
    ...
    private:
        ...
        LPVOID mapView = nullptr;
#endif
        //pointer to start of mapped file data, or nullptr if not mapped
    ...
    public:
        ...
        CompactHistoryBlock()
        {
            ...
            blockStart = reinterpret_cast<quint8*>(malloc(blockLength));
            assert(blockStart != nullptr);
